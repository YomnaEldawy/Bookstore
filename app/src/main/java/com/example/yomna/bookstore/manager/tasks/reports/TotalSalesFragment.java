...
public class TotalSalesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_total_sales, container, false);
        bookSales = new ArrayList<BookSales>();
        listView = myView.findViewById(R.id.listView_total);
        getTotalBooks(new VolleyCallbackSale() {
            @Override
    ...
    public void getWholeListViewItemsToBitmap(ListView p_ListView) {
        ...
        storeImage(bigbitmap, "Total.jpg");
        ...
        String input = Environment.getExternalStorageDirectory()
                .getAbsolutePath() + "/myAppDir/Total.jpg";
        String filePath = sdIconStorageDir.toString() + File.separator + "TotalSales.pdf";
    ...
    private void getTotalBooks(final VolleyCallbackSale onCallback){
        ...
        getTotalSalesRequest r1 = new getTotalSalesRequest(responseListener);
